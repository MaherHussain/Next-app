...
export default function Login() {
    ...
    return (
        <form className="flex flex-col gap-4 w-full max-w-md mx-auto" onSubmit={handleSubmit}>
            <h1 className="text-2xl font-bold text-center">Login as Partner</h1>
            ...
            <div className="text-center mt-4">
                <p className="text-gray-600">
                    ...
                    <a href="/auth/partner/register" className="text-orange-600 hover:text-orange-700 font-medium">
                        Register here
                    </a>
                </p>
            </div>
