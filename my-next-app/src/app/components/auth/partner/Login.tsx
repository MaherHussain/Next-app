...
export default function Login() {
    ...
    return (
        <form className="flex flex-col gap-4 w-full max-w-md mx-auto" onSubmit={handleSubmit}>
           ...
           <div className="text-left"> <p>Don't have partner account? <span className="text-orange-500 hover:text-orange-700"><Link href="/auth/partner/register">Register</Link></span></p></div> 
            <Button 
                buttonText="Login" 
                isLoading={isPending} 
