...
export default function Page() {
  ...
  return (
    <div>
      <button onClick={() => router.push("/partner/dashboard/products")} className=" flex flex-row items-center gap-2 mb-4  text-gray-600 hover:text-gray-800 font-medium cursor-pointer">
        <FaArrowLeftLong />
        <span>back to products</span>
      </button>
      <div className="flex items-center justify-between">
        <h1 className='text-2xl font-bold text-gray-900' >Ingredients ({listCount})</h1>
        <button
